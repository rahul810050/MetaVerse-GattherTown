...
//     const asUser = `cocane${Math.random().toString(36)}`
...
//       type: "admin",
//     });
//     const adminRes = await axios.post(`${BACKEND_URL}/api/v1/signin`, {
//       username,
//       password,
//     });
...
//     // to create an avatar which is created by an admin 
...
//   beforeAll(async () => {
//     const adminName = `rahul${Math.random().toString(36).substring(7)}`;
//     const password = "123456";
// 		// admin 
//     const signupRes = await axios.post(`${BACKEND_URL}/api/v1/signup`, {
//     adminName,
...
// 		// user
//     const username = `cocane${Math.random().toString(36).substring(7)}`
